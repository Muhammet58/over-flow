...
function toggleAnswerVoteIncrease(answer_id) {
    var vote_text = document.getElementById("answerVoteText" + answer_id);
    $.ajax({
        type:'GET',
        url:'/answer-vote-increase/' + answer_id,
        dataType: 'json',
        success: function (response) {
            vote_text.innerText = response.increase_vote
        },
...
function toggleAnswerVoteDecrease(answer_id) {
    var vote_text = document.getElementById("answerVoteText" + answer_id);
    $.ajax({
        type:'GET',
        url:'/answer-vote-decrease/' + answer_id,
        dataType: 'json',
        success: function (response) {
            vote_text.innerText = response.decrease_vote
        },
