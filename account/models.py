...
from pages.models import Questions, Answers, Tags
...
class UserProfile(models.Model):
    ...
    user_questions = models.ManyToManyField(Questions, related_name='asked_by', blank=True)
    user_answers = models.ManyToManyField(Answers, related_name='answered_by', blank=True)
    user_tags = models.ManyToManyField(Tags, related_name='questions_tag', blank=True)
